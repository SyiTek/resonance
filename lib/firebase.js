 ...
 * @property {string} title - Commission title
 * @property {string} description - Description of the commission
 * @property {string} type - Type of commission
 * @property {string} target - Target of the commission
 * @property {string} reward - Reward offered
 * @property {string} deadline - Deadline for completion
 * @property {string} priority - Priority level
 * @property {boolean} anonymous - Whether the requester is anonymous
 * @property {string} [contactInfo] - Optional contact information
 * @property {string} requesterName - Name of the requester
 * @property {string} status - Status of the commission
 */
...
/**
 * Create a new commission in Firestore
 * @param {Commission} commissionData - The commission data
